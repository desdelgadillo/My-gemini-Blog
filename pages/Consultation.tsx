    ...
    <div className="max-w-4xl mx-auto py-12 animate-in fade-in duration-500">
      <div className="bg-slate-900 text-white rounded-3xl p-8 md:p-16 relative overflow-hidden mb-12">
        <div className="absolute top-0 right-0 p-8 opacity-10">
          <svg className="w-64 h-64" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 max-w-2xl">
            <div className="relative">
              <label htmlFor="ai-consult-input" className="sr-only">Your accessibility question</label>
              <textarea
                id="ai-consult-input"
                value={query}
          ...
          {/* This region announces advice automatically when it arrives */}
          <div 
            className="mt-8"
            role="status" 
            aria-live="polite"
          ...
          >
            {response && (
              <div className="p-6 bg-slate-800/50 border border-slate-700 rounded-2xl animate-in slide-in-from-top-4 duration-300">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-20">
        <div className="p-8 bg-white rounded-3xl border border-slate-100 shadow-sm">
          ...
          <ul className="space-y-3 mb-8 text-sm text-slate-700">
            <li className="flex items-center gap-2"><svg className="h-5 w-5 text-green-600" aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg> ARIA Best Practices</li>
            <li className="flex items-center gap-2"><svg className="h-5 w-5 text-green-600" aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg> Manual Testing with Screen Readers</li>
            <li className="flex items-center gap-2"><svg className="h-5 w-5 text-green-600" aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg> Inclusive Content Strategy</li>
          </ul>
        ...
        <div className="p-8 bg-blue-600 text-white rounded-3xl shadow-xl shadow-blue-200">
          ...
          <ul className="space-y-3 mb-8 text-sm text-blue-100">
            <li className="flex items-center gap-2"><svg className="h-5 w-5" aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg> Individual Education Plans</li>
            <li className="flex items-center gap-2"><svg className="h-5 w-5" aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg> Workspace Efficiency Audits</li>
            <li className="flex items-center gap-2"><svg className="h-5 w-5" aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg> Braille Productivity Training</li>
          </ul>
